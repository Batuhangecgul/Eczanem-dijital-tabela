 ...
 * Optimized source selection based on user city/location.
 * Uses Istanbul Eczacı Odası AJAX data for Istanbul/Yalova.
 * Other cities continue with eczaneler.gen.tr.
 */
...
async function scrapePharmacies(city, district = '') {
    ...
    console.log(`   Using source: ${source} for city=${city}`);
